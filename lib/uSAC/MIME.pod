...
Removes aa single mapping from file extension to mime type. The  C<index> method
will need to be called after to construct a new lookup hashes
...
A very basic benchmark of performing a forward lookup of "txt" extension, comparing this modules to L<Plack::MIME> and L<MIME::Detect> locally on my laptop
	Module		 Lookup rate
	MIME::Detect		167/s
	Plack::MIME		
	uSAC::MIME
